...
static int ubus_peer_cb(struct ubus_context *ctx, struct ubus_object *obj,
...
static const struct ubus_method btle_methods[] = {
	UBUS_METHOD_NOARG("peers", ubus_peer_cb),
};

static struct ubus_object_type ubus_object_type =
	UBUS_OBJECT_TYPE("btle", btle_methods);

static struct ubus_object ubus_object = {
	.name = "btle",
	.type = &ubus_object_type,
	.methods = btle_methods,
	.n_methods = ARRAY_SIZE(btle_methods),
};
